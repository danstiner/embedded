 ...
 *
 * Vendored from ncs-zigbee samples/shell/include/zb_range_extender.h — the ZBOSS
 * Range Extender (router) device type (Basic + Identify) isn't exposed by a public
 * add-on header, so the device-definition macros are copied here verbatim.
 */
