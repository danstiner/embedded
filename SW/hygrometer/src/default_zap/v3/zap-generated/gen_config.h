...
// Use this macro to check if the server side of the Relative Humidity Measurement cluster is
// included
...
// Use this macro to check if the server side of the Carbon Dioxide Concentration Measurement
// cluster is included
