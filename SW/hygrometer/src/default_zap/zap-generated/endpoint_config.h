...
#define GENERATED_DEFAULTS                                                                         \
	{                                                                                          \
		...
		43, 'P', 'r', 'e', 's', 's', ' ', 't', 'h', 'e', ' ', 'b', 'u', 't', 't', 'o',     \
			'n', ' ', 's', 'p', 'e', 'c', 'i', 'f', 'i', 'e', 'd', ' ', 'i', 'n', ' ', \
	...
	{                                                                                          \
		...
		{ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY),                              \
		 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                            \
			...
			{ZAP_EMPTY_DEFAULT(), 0x00000008, 1, ZAP_TYPE(ENUM8),                      \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* MeasurementUnit */              \
			{ZAP_EMPTY_DEFAULT(), 0x00000009, 1, ZAP_TYPE(ENUM8),                      \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* MeasurementMedium */            \
			{ZAP_EMPTY_DEFAULT(), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32),                   \
			 ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) |                                    \
				 ZAP_ATTRIBUTE_MASK(READABLE)}, /* FeatureMap */                   \
			{ZAP_SIMPLE_DEFAULT(3), 0x0000FFFD, 2, ZAP_TYPE(INT16U),                   \
...
#define GENERATED_ENDPOINT_TYPES                                                                   \
	{                                                                                          \
		{ZAP_CLUSTER_INDEX(0), 15, 152}, {ZAP_CLUSTER_INDEX(15), 6, 38},                   \
	}
