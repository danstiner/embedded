...
#define MATTER_DM_TEMPERATURE_MEASUREMENT_CLUSTER_SERVER_ENDPOINT_COUNT (3)
...
// Use this macro to check if the server side of the Relative Humidity
...
// Use this macro to check if the server side of the Soil Measurement cluster is
// included
